...
fn main() {
    ...
    //配列を作成する
    let numbering = ["first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eighth", "ninth", "tenth", "eleventh", "twelfth"];
    
    //歌詞を表示する
    for number in 0..12 {
        println!("On the {} day of Christmas, my true love sent to me", numbering[number]);
        ...
        if number >= 44 {println!("Five golden rings");}
